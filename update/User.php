...
class User extends Authenticatable implements JWTSubject
{
    ...
    {
        // Avoid triggering accessors that make database queries
        // Calculate profile status directly without using accessors
        $hasProfile = false;
        $profileComplete = false;
        
        try {
            // Directly check profile without triggering accessors
            ...
            // If profile check fails, use defaults
        }
