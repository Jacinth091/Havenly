...
class Tenant extends Model
{
     ...
     * Note: Only include simple computed attributes that don't make DB queries.
     * Expensive attributes like has_active_lease, outstanding_balance, etc. 
     * should be loaded explicitly when needed to avoid N+1 query issues.
     */
    protected $appends = [
        'full_name',
